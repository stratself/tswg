...
# wg-quick with small modifications:
# - remove auto_su for non-root execution
# - Set sysctl only if necessary (https://lists.zx2c4.com/pipermail/wireguard/2023-February/007936.html)
